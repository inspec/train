...
describe "local transport" do
  ...
  describe "when running a local command" do
    it "gets stdout" do
      x = rand.to_s
      result = Train::Transports::Local::CommandResult.new(x, nil, 0)
      connection.stub :run_spawned_command, result do
    ...
    it "gets stderr" do
      x = rand.to_s
      result = Train::Transports::Local::CommandResult.new(nil, x, 0)
      connection.stub :run_spawned_command, result do
    ...
    it "gets exit_status" do
      x = rand(100)
      result = Train::Transports::Local::CommandResult.new(nil, nil, x)
      connection.stub :run_spawned_command, result do
